...
!!! Checklist  
    ...
    - Choose a metadata standard used by your community - Bioschemas or RDA.
    - Describe your training material using the properties of that metadata standard.
    - Add the metadata into a README file, with the materials, or in the HTML/GitHub page where your training materials can be found, or within the training material itself (a ppt or pdf for instance).
    - Use a validator to check the metadata you added.
